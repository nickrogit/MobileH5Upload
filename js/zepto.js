    ...
    css: function(property, value){
      if (arguments.length < 2) {
        ...
        if (typeof property == 'string'){
			...
			//edit by maixj at 20140219 to fix css problem
...
//add by maixj to use touch-plugin
;(function($){
  var touch = {},
    ...
    var Popup = (function () {
        var Popup = function (containerEl, opts) {
            ...
            try {
				...
				if(opts.id === 'slideup'){//这里增加一个从设备底部弹出的窗口
					this.slideup();
					return false;
				}
                queue.push(this);
        ...
        Popup.prototype = {
			slideup:function(){
				...
				$('#slideup').animate({bottom:0},300);
				Mask.show(0.3);
                $('#submitbtn').bind('click', function (e) {
					_this.onOk.call(_this.onOk, _this);
					if (_this.closeOnOk)_this.hide();
					e.preventDefault();
                });
			},
            show: function () {
                ...
                markup +='<div class="content-body">' + this.message + '</div>'+
                         '<footer style="clear:both;">'+
                             '<a href="javascript:;" class="car-popup-cancel ' + this.cancelClass + '">' + this.cancel + '</a>'+
